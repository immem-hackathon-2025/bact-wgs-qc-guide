...
| --- | --- | --- | --- | --- | --- |
| N50 | Length of the shortest contig in the sequenced genome that together with other (longer) contigs make up at least 50% of the entire genome | Qualibacta/Aquamisb | Assembly may be too fragmented for reliable analysis | Assembly quality | 4 |
| Total assembly length | Sum of the lengths of all contigs or scaffolds in an assembled genome. Can be compared to the expected genome size to assess completeness | Qualibact/Aquamisb | Too short may indicate missing data; too long may suggest contamination or misassembly | Assembly quality | 4 |
| GC Content | Percentage of the bases guanine and cytosine in the genome. The GC content differs between species | Qualibact/Aquamisb | Suggests contamination with another species | Sequence quality / Assembly | 1, 3, 4 |
| Number of contigs | Count of contiguous assembled sequences in a genome assembly | Qualibact/Aquamisb | Fewer contigs generally indicate a more contiguous and higher-quality assembly, while many contigs may suggest fragmentation or assembly difficulties | Sequence quality / Assembly | 4 |
...
| Completeness | Estimated completeness of genome as determined from the presence/absence of marker genes | Qualibact | Parts of the genome may be missing from the assembly |  |  |
| Contamination | Estimated contamination of genome e.g. determined by the presence of multi-copy marker genes or by sequences assigned to species | Qualibact (CheckM)/ Aquamisb (ConFindr) | Foreign or unexpected DNA may be present, which can compromise the accuracy of the assembly and downstream analyses | Sequence quality | 1, 3, 4 |
| Total coding sequences | Number of open reading frames identified in a genome | Qualibact | Too low suggests part of the genome is missing, too high might suggest contamination | Assembly / Annotation metric | 4 |
...
ahttps://happykhan.github.io/qualibact/

bhttps://gitlab.com/bfr\_bioinformatics/AQUAMIS
